...
(()=>{
    ...
    const preferDarkScheme = globalThis.matchMedia('(prefers-color-scheme: dark)');
    // Determine the initial theme based on stored preference or system preference.
    let initialTheme;
    if (storedTheme === darkTheme || storedTheme === lightTheme) initialTheme = storedTheme;
    else initialTheme = preferDarkScheme.matches ? darkTheme : lightTheme;
    // Set the initial theme on the root HTML element.
    document.documentElement.dataset.theme = initialTheme;
})();

//# sourceMappingURL=github-user-search-app.289ed980.js.map
